...
//{
//    int r = abs(dr - sr);
//    int colDiff = abs(dc - sc);
//    // Normal king move
//    if (r <= 1 && colDiff <= 1)
//        return true;
//    // CASTLING
//    if (r == 0 && colDiff == 2 && !hasMoved)
//    {
//        int row = sr;
...
//                grid[i][j]->getSymbol() == (color == "White" ? "♔" : "♚"))
//            {
//                kr = i;
//                kc = j;
//                return;
...
// =====================================================
// EXACT CORRECTED CHECK / CHECKMATE CODE
// Paste and replace your existing functions
// =====================================================
...
// =====================================================
// CORRECTED KING VALIDATION
// Replace your normal move section only
// =====================================================
